...
const APP_EMAIL = "pandascoops@pscoops.com";
const APP_PHONE = "+92 300 1234567";
const APP_PHONE_2 = "+92 321 9876543";

export function Contact() {
	return (
		<div className="mx-auto h-full min-h-screen max-w-5xl lg:border-x py-24">
			...
			<div className="grid md:grid-cols-3">
				<Box
					description="We will get back to you soon ^_^"
					icon={Mail}
					title="Email"
				>
					<a
				...
				>
					<span className="font-medium font-mono text-sm tracking-wide">
						01, Sajjan Rao Cir, opp. V. B. Bakery, Vishweshwarapura, Basavanagudi, Bengaluru, Karnataka 560004
					</span>
				</Box>
				<Box
					className="border-b-0 md:border-r-0"
					description="We're available Mon-Fri, 9am-10pm."
					icon={Phone}
					title="Phone"
				>
					<div>
			...
			<div className="z-1 flex h-full flex-col items-center justify-center gap-4 py-24">
				...
				<div className="flex flex-wrap items-center gap-2">
						<a
							...
							target="_blank"
						>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" className="lucide lucide-instagram-icon lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
						...
						<a
							...
							target="_blank"
						>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" className="lucide lucide-facebook-icon lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
							<span className="font-medium font-mono text-xs tracking-wide">
								Instagram
							</span>
						</a>
